...
namespace JX.WPFToolkit.Helpers
{
	/// <summary>
	/// Base class for all ViewModel classes in the application.  It provides support for property change notifications  and has a DisplayName property.
	/// </summary>
